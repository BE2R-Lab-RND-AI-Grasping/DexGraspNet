...
def generate(args_list):
    ...
    hand_model = HandModel_Mujoco(
        ...
        mjcf_path='mjcf/' + args.hand_name + "/" + args.hand_name + '_prim.xml',
...
if __name__ == '__main__':
    ...
    # experiment settings
    parser.add_argument('--hand_name', default='DIP-Flex_opened_kinematics')
    ...
    parser.add_argument('--batch_size_each', default=600, type=int) # Number of generated poses
    parser.add_argument('--max_total_batch_size', default=1200, type=int)
    parser.add_argument('--n_iter', default=650, type=int)
    # hyper parameters

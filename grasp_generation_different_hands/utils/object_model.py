...
class ObjectModel:
    ...
    def __init__(self, data_root_path, batch_size_each, num_samples=2000, device="cuda"):
        ...
        self.scale_choice_michail_dataset = torch.tensor([0.001, 0.001, 0.001, 0.001, 0.001], dtype=torch.float, device=self.device) 
    ...
    def initialize(self, object_code_list):
        ...
        for object_code in object_code_list:
            ...
            if object_code == "hummer" or object_code == "screwdriver" or object_code == "pliers":
